<html>
	...
	<body style="width:793.700787402px; height:1099.842519685px;">
		<div style="padding:20px 5px; border-bottom:1px dashed #999;">
			<button onclick="window.location.href='@{{ URL::to('operasi/dokumen', $sprin->id_operasi) }}'">Kembali</button>
			<button onclick="window.location.href='@{{ URL::to('cetak/sprin', $sprin->id_operasi) }}'" style="float:right">Cetak</button>
		</div>

		<div style="width:793.700787402px; height:1099.842519685px;">
			<table border="0px" style="margin-top:20px;">
		  	...
		  	<table border="0px" style="float:right; margin-top: 25px;">
				...
				<tr style="">
					<td colspan="3" style="text-align:center; border-top:1px solid;">@{{ $sprin->sprin_pangkat }} NRP: @{{ $sprin->sprin_nrp }}</td>
				</tr>
		  	</table>
	  	...
	  	<div style="padding:1px; margin-top:150px; border-top:1px dashed #999; width:793.700787402px; height:1099.842519685px;">
		  	...
		  	<table border="0px" style="float:right; margin-top: 25px;">
				...
				<tr style="">
					<td colspan="2" style="text-align:center; border-top:1px solid;">@{{ $sprin->sprin_pangkat }} NRP: @{{ $sprin->sprin_nrp }}</td>
				</tr>
		  	</table>
	  	</div>
	</body>
