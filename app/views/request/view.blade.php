...
?>
    ...
    @if ( $aktifitasUser['inputRequest'] == 'available' )
		...
		<div class="header">
	  	...
	  	<div class="content">
	     	<form action="@{{ URL::to('detailoperasi/create') }}" method="POST" class="form-horizontal group-border-dashed" role="form" parsley-validate novalidate enctype="multipart/form-data" style="border-radius: 0px;">
